...
class MJT_迈均凸_UI:
    def __init__(self, parent, on_execute, font_size=12):
        ...
        self.param_file = os.path.join(config_dir, "MJT_迈均凸_params.json")
    ...
    def _on_run(self):
        try:
            ...
            execute_lisp(None, "迈均凸模", "MJT_迈均凸.lsp", "mjt", values, _build_args, TEMPLATE_PATH, LSP_DIR)
        except Exception as e:
