...
class JZM_锥度_基准模_UI:
    def __init__(self, parent, on_execute, font_size=12):
        ...
        self.param_file = os.path.join(config_dir, "JZM_锥度_基准模_params.json")
    ...
    def create_ui(self, frame):
        ...
        def _on_run(self):
            try:
                ...
                execute_lisp(None, "锥度基准模", "JZM_锥度_基准模.lsp", "jzm2", values, _build_args, TEMPLATE_PATH, LSP_DIR)
                messagebox.showinfo("成功", "锥度基准模绘制完成！")
            except Exception as e:
